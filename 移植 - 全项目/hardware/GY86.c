...
{
  uint8_t BUF_H,BUF_L;
	BUF_H = GY86_ReadRegister(HMC5883L_READ_ADDRESS, HMC5883L_X_M);
	BUF_L = GY86_ReadRegister(HMC5883L_READ_ADDRESS, HMC5883L_X_L);
	*x = BUF_H<<8 | BUF_L;
	
	BUF_H = GY86_ReadRegister(HMC5883L_READ_ADDRESS, HMC5883L_Y_M);
	BUF_L = GY86_ReadRegister(HMC5883L_READ_ADDRESS, HMC5883L_Y_L);
	*y = BUF_H<<8 | BUF_L;
	
	BUF_H = GY86_ReadRegister(HMC5883L_READ_ADDRESS, HMC5883L_Z_M);
	BUF_L = GY86_ReadRegister(HMC5883L_READ_ADDRESS, HMC5883L_Z_L);
	*z = BUF_H<<8 | BUF_L;
